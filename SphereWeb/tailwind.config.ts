  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sphere: {
          safe: "hsl(var(--sphere-safe))",
          pending: "hsl(var(--sphere-pending))",
          committed: "hsl(var(--sphere-committed))",
          buffer: "hsl(var(--sphere-buffer))",
        },
        category: {
      ...
      boxShadow: {
        'sphere-sm': 'var(--shadow-sm)',
        'sphere-md': 'var(--shadow-md)',
        'sphere-lg': 'var(--shadow-lg)',
        'sphere-card': 'var(--shadow-card)',
        'sphere-card-hover': 'var(--shadow-card-hover)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
